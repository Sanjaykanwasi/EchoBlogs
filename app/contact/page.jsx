      ...
      <section className="px-4 sm:px-8 md:px-16 lg:px-28 py-16 sm:py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Have a question about Echo Blogs? Want to collaborate on a project?
      ...
      <section className="px-4 sm:px-8 md:px-16 lg:px-28 py-16 bg-accent/30">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card/50 p-6 rounded-lg border border-border">
              <h3 className="text-lg font-semibold text-foreground mb-2">
                Can I contribute to Echo Blogs?
              </h3>
              <p className="text-muted-foreground">
                Absolutely! Echo Link is open source. Check out the GitHub
